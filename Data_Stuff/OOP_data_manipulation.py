...
class Data():
    ...
    def choose_dataset(self, input_var:str, delim:str, input_option:str):
        dataset_df = None 
    ...
    def format_dataframe(self, dataset_df: dataframe, label_str: str):
    ...
    def feature_label_split(self, dataset_list: list, the_label_position: int):
        dataset_dict = {}
    ...
    def random_train_test_split(self, dataset_df: dataframe, train_perc: float):
        output_list = []
        ...
        self.self.ttv_split_data = output_list
    ...
    #                                                   |                    |                    | 
    #---------------------------------------------------#--------------------#--------------------#
    def random_train_test_validation_split(self, dataset_df: dataframe, train_perc: float):
        output_list = []
        dataset_df_copy = dataset_df.copy()
    ...
    def temporal_test_validation_split(self):
        #TODO 
        return 0
    ...
    #  
    def get_eigen_vectors(self, dataset_df, n_components):
    ...
    def apply_pca(self, dataset_df, eigen_vectors):
        dataset_np = dataset_df.to_numpy() #converts the dataframe into a numpy array
    ...
    def pca(self, dataset_df, n_components):
        eigen_vectors = get_eigen_vectors(dataset_df, n_components)
        pca_matrix = apply_pca(dataset_df, eigen_vectors)
    ...
    def noise_addition(self, df: dataframe, mu: int = 0):
